...
No unresolved implementation decisions remain here for issue #2. Exact runner command names are implementation details, but any introduced runner must document and preserve the behavior above.
